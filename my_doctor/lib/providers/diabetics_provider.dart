          ...
          .map(
            (item) => ResultDiabetics(
              ...
              diabeticsModel: DiabeticsModel(
                glucose: int.parse(item['glucose'].toString()),
                bloodPressure: int.parse(item['bloodPressure'].toString()),
                skinThickness: int.parse(item['skinThickness'].toString()),
                insulin: int.parse(item['insulin'].toString()),
                bmi: num.parse(item['bmi'].toString()),
                diabetesPedigreeFunction:
                    num.parse(item['diabetesPedigreeFunction'].toString()),
